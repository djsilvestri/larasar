          ...
          <div class="col-md-6 q-pa-md">
            <q-card class="my-card text-white">
              <q-card-section class="bg-primary">
                <div class="text-h6">{{$t('login')}} <q-btn color="#fff;" flat :label="$t('Not a member yet?')" to="/register" class="q-ma-sm"/></div>
                <div class="text-subtitle2">personalized at-home learning</div>
              </q-card-section>
              ...
              <div class="q-pa-md">
                ...
                <template class="*col-md-12">
                  ...
                  <!-- <login-with-social /> -->
                  <q-checkbox v-model="remember" style="color: #000;" :label="$t('remember_me')" />
...
export default {
  ...
  data () {
    return {
      loader: false,
      email: process.env.DEV ? 'pilot@somewhere.com' : null,
      email_data: null,
      password: process.env.DEV ? '12345678' : null,
      password_data: null,
      isPwd: true,
      remember: false
    }
